<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wamp\www\shop\public/../application/admin\view\admin\edit.htm ";i:1555044505;s:65:"E:\wamp\www\shop\public/../application/admin\view\public\top.htm ";i:1555007037;s:66:"E:\wamp\www\shop\public/../application/admin\view\public\left.htm ";i:1555285415;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>二手交易论坛</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="name" required="" type="text" value="<?php echo $admin['name']; ?>">
                                <!--传值过来-->
                            </div>
