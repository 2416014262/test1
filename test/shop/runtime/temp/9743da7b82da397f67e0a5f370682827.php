<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\wamp\www\shop\public/../application/index\view\search\search.htm ";i:1556866294;s:66:"E:\wamp\www\shop\public/../application/index\view\public\head.htm ";i:1556865120;}*/ ?>
...
<input name="keywords" type="text" style="background-color: #000000;padding-left: 10px; font-size: 12px;font-family: 'Microsoft Yahei'; color: #999999;height: 29px; width: 160px; border: solid 1px #666666; line-height: 28px;" id="go" value="" onfocus="if(this.value=='在这里搜索...'){this.value='';}"  onblur="if(this.value==''){this.value='';}" />
    ...
    <div id="xh_container">
        ...
        <div class="path">搜索结果:<font style="color:red;"><?php echo $keywords; ?></font>
...
<?php if($keywords != ''): if(is_array($serRes) || $serRes instanceof \think\Collection): $i = 0; $__LIST__ = $serRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
    <div class="xh_post_h_3 ofh">
                            <div class="xh">
                                <a target="_blank" href="<?php echo url('article/index',array('artid'=>$art['id'])); ?>" title="<?php echo $art['title']; ?>"> <img src="<?php echo $art['thumb']; ?>" alt="<?php echo $art['title']; ?>" height="240" width="400"></a>
                            </div>
                            <div class="r ofh">
                                ...
                                <div class="b">
                                    <a href="<?php echo url('article/index',array('artid'=>$art['id'])); ?>" class="xh_readmore" rel="nofollow">read
                                        more</a> <span title="<?php echo $art['zan']; ?>" class="xh_love"><span class="textcontainer"><span><?php echo $art['zan']; ?></span></span> </span> <span title="人浏览" class="xh_views">
                                                     <?php echo $art['click']; ?></span>
                                </div>
                            </div>
                        </div>
                <?php endforeach; endif; else: echo "" ;endif; else: ?>
            <div class="xh_post_h_3 ofh"><h2><font style="color:red;">没有搜索关键词</font>    </h2>   </div>    
            <?php endif; ?>
