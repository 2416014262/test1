<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\wamp\www\shop\public/../application/index\view\register\index.htm ";i:1556866788;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml"><!--Head--><head>
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="http://127.0.0.1/shop/public/static/admin/style/beyond.css" rel="stylesheet">
        ...
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input value="users" class="form-control" placeholder="name" name="username" type="text">
                </div>
                <div class="loginbox-textbox">
                    <input class="form-control" placeholder="password" name="password" type="password">
                </div>
                <div class="loginbox-textbox">
                    <input class="form-control" placeholder="password" name="confirmpassword" type="password">
                </div>
                ...
                <div class="logobox">
                    <p class="text-center"><a href="<?php echo url('user/login'); ?>">登录用户</a></p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
