<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp\www\shop\public/../application/admin\view\article\add.htm ";i:1555175943;s:65:"E:\wamp\www\shop\public/../application/admin\view\public\top.htm ";i:1555007037;s:66:"E:\wamp\www\shop\public/../application/admin\view\public\left.htm ";i:1555285415;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>二手交易论坛</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('cate/lst'); ?>">文章管理</a>
                        <!-- 跳转 -->
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('article/add'); ?>" method="post"
