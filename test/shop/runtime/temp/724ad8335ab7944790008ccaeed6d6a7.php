<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp\www\shop\public/../application/admin\view\article\lst.htm ";i:1555220242;s:65:"E:\wamp\www\shop\public/../application/admin\view\public\top.htm ";i:1555007037;s:66:"E:\wamp\www\shop\public/../application/admin\view\public\left.htm ";i:1555285415;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>二手交易论坛</title>
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody> 
                             <?php if(is_array($articleres) || $articleres instanceof \think\Collection): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?>                
                             <tr>
                                ...
                                <td align="center">
                                 ...
                                 <td align="center">
                                    ...
                                    <img src="<?php echo $article['thumb']; ?>" height="100">
                                    <?php else: ?>
                                    缩略图
                                    <?php endif; ?>
                                 </td>                                
                                <td align="left">sjh</td>
