<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\wamp\www\shop\public/../application/index\view\user\login.htm ";i:1556866697;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center"><a href="<?php echo url('register/index'); ?>">注册用户</a></p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
